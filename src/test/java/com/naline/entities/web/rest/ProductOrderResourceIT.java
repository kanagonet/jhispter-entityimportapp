...
import static com.naline.entities.domain.ProductOrderAsserts.*;
import static com.naline.entities.web.rest.TestUtil.createUpdateProxyForBean;
import static com.naline.entities.web.rest.TestUtil.sameNumber;
...
import com.naline.entities.IntegrationTest;
import com.naline.entities.domain.Product;
import com.naline.entities.domain.ProductOrder;
import com.naline.entities.domain.ShoppingCart;
import com.naline.entities.repository.ProductOrderRepository;
import com.naline.entities.service.ProductOrderService;
...
class ProductOrderResourceIT {
    ...
    public static ProductOrder createUpdatedEntity(EntityManager em) {
        ProductOrder updatedProductOrder = new ProductOrder().quantity(UPDATED_QUANTITY).totalPrice(UPDATED_TOTAL_PRICE);
        // Add required entity
        Product product;
        if (TestUtil.findAll(em, Product.class).isEmpty()) {
        ...
        updatedProductOrder.setProduct(product);
        // Add required entity
        ShoppingCart shoppingCart;
        if (TestUtil.findAll(em, ShoppingCart.class).isEmpty()) {
        ...
        updatedProductOrder.setCart(shoppingCart);
