package com.naline.entities.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.naline.entities.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.naline.entities.repository.UserRepository.USERS_BY_EMAIL_CACHE);
