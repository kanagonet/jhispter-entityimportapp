...
export const ShoppingCartDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="entityimportappApp.shoppingCart.delete.question">
        <Translate contentKey="entityimportappApp.shoppingCart.delete.question" interpolate={{ id: shoppingCartEntity.id }}>
