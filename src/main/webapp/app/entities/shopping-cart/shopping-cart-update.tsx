  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="entityimportappApp.shoppingCart.home.createOrEditLabel" data-cy="ShoppingCartCreateUpdateHeading">
            <Translate contentKey="entityimportappApp.shoppingCart.home.createOrEditLabel">Create or edit a ShoppingCart</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('entityimportappApp.shoppingCart.placedDate')}
              ...
              />
              <ValidatedField
                label={translate('entityimportappApp.shoppingCart.status')}
              ...
              >
                {orderStatusValues.map(orderStatus => (
                  <option value={orderStatus} key={orderStatus}>
                    {translate(`entityimportappApp.OrderStatus.${orderStatus}`)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('entityimportappApp.shoppingCart.totalPrice')}
              ...
              />
              <ValidatedField
                label={translate('entityimportappApp.shoppingCart.paymentMethod')}
              ...
              >
                {paymentMethodValues.map(paymentMethod => (
                  <option value={paymentMethod} key={paymentMethod}>
                    {translate(`entityimportappApp.PaymentMethod.${paymentMethod}`)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('entityimportappApp.shoppingCart.paymentReference')}
              ...
              <ValidatedField
                ...
                label={translate('entityimportappApp.shoppingCart.customerDetails')}
                type="select"
                required
              >
                <option value="" key="0" />
