...
export const ProductOrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="entityimportappApp.productOrder.delete.question">
        <Translate contentKey="entityimportappApp.productOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
