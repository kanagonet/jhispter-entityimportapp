    ...
    <Row>
      <Col md="8">
        <h2 data-cy="productOrderDetailsHeading">
          <Translate contentKey="entityimportappApp.productOrder.detail.title">ProductOrder</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="entityimportappApp.productOrder.product">Product</Translate>
          </dt>
          <dd>{productOrderEntity.product ? productOrderEntity.product.name : ''}</dd>
          <dt>
            <Translate contentKey="entityimportappApp.productOrder.cart">Cart</Translate>
          </dt>
