...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="entityimportappApp.productCategory.delete.question">
        <Translate contentKey="entityimportappApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
