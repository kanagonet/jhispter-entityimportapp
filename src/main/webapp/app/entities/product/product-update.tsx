  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="entityimportappApp.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
            <Translate contentKey="entityimportappApp.product.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('entityimportappApp.product.name')}
                id="product-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('entityimportappApp.product.description')}
              ...
              />
              <ValidatedField
                label={translate('entityimportappApp.product.price')}
                id="product-price"
                name="price"
                data-cy="price"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('entityimportappApp.product.productSize')}
              ...
              >
                {sizeValues.map(size => (
                  <option value={size} key={size}>
                    {translate(`entityimportappApp.Size.${size}`)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedBlobField
                label={translate('entityimportappApp.product.image')}
                id="product-image"
                name="image"
                data-cy="image"
                isImage
              ...
              <ValidatedField
                ...
                label={translate('entityimportappApp.product.productCategory')}
                type="select"
                required
              >
                <option value="" key="0" />
