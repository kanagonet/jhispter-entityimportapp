...
export const ProductDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="entityimportappApp.product.delete.question">
        <Translate contentKey="entityimportappApp.product.delete.question" interpolate={{ id: productEntity.id }}>
