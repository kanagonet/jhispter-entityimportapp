  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="entityimportappApp.customerDetails.home.createOrEditLabel" data-cy="CustomerDetailsCreateUpdateHeading">
            <Translate contentKey="entityimportappApp.customerDetails.home.createOrEditLabel">Create or edit a CustomerDetails</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('entityimportappApp.customerDetails.gender')}
              ...
              >
                {genderValues.map(gender => (
                  <option value={gender} key={gender}>
                    {translate(`entityimportappApp.Gender.${gender}`)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('entityimportappApp.customerDetails.phone')}
              ...
              />
              <ValidatedField
                label={translate('entityimportappApp.customerDetails.addressLine1')}
              ...
              />
              <ValidatedField
                label={translate('entityimportappApp.customerDetails.addressLine2')}
              ...
              />
              <ValidatedField
                label={translate('entityimportappApp.customerDetails.city')}
              ...
              />
              <ValidatedField
                label={translate('entityimportappApp.customerDetails.country')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('entityimportappApp.customerDetails.user')}
                type="select"
                required
              >
                <option value="" key="0" />
