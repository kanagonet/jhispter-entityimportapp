...
export const CustomerDetailsDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/customer-details${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="entityimportappApp.customerDetails.delete.question">
        <Translate contentKey="entityimportappApp.customerDetails.delete.question" interpolate={{ id: customerDetailsEntity.id }}>
